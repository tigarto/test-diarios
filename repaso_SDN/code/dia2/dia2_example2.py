...
Name: dia2_example1.py

Resumen: Este codigo permite la comunicacion de dos contenedores conectados mediante un switch. 
El controlador se ejecuta en el localhost.
